...
def main(fname, output=False, verbose=True):
    ...
    with open(fname, "r") as f:
        ...
        #date = Time(mean_obs_time, format="mjd")
        ...
        DIT = header["ESO DET DIT"] # ESO DET DIT: 180.0
...
############################################################
            ...
            out.write("Key observation values\n")
        ...
        #ESO TEL AIRM START: 1.214
            ...
            out.write("DIT-intergration time     = {}\n".format(DIT))
