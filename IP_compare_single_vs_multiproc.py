...
def multi_IPconvolution(wav, flux, chip_limits, R, FWHM_lim=5.0, plot=True, verbose=True, numProcs = None):
...
if __name__ == "__main__":
    ...
    R = 2000
    single_convolved_wav, single_convolved_flux = single_IPconvolution(wav, flux, chip_limits, R, FWHM_lim=5.0, plot=False, verbose=True)

    multi_convolved_wav, multi_convolved_flux = multi_IPconvolution(wav, flux, chip_limits, R, FWHM_lim=5.0, plot=False, verbose=True)
    ...
    plt.plot(single_convolved_wav,
             [single/multi for single, multi in zip(single_convolved_flux,multi_convolved_flux)], 'r', label = 'single')
